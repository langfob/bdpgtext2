#===============================================================================
#
#               p8.BoxCoxAndNormalizingFunctions.v01.R
#
#===============================================================================
...
#  
#  - Created by copying most of the p3 preprocessing code in 
#    bdpgtext/R/v1_paper_3_feature_preprocessing_functions.R.  
#    Left out the last function in that file which had to do with finding 
#    and removing highly correlated columns.  That function was never called 
#    in the p3 code.
