#===============================================================================
#
#                   v1_Paper_2_func_defns_for_plotting.R
#
#===============================================================================
...
ggplot_boxplot_over_bins <- function (data, 
                                      x_grouping_var,    # = input_error_group_by_max_FN_FP, 
...
###    data = filter (data, {{facet_var}} %in% rs_method_names_to_show)
    ...
    ggplot (data, 
            ### aes (x    = {{x_grouping_var}},    # input_error_group_by_max_FN_FP, 
            ###      y    = {{y_output_var}},    # rsr_COR_euc_out_err_frac, 
            ###      fill = {{x_grouping_var}}    # input_error_group_by_max_FN_FP
            aes (x    = .data[[x_grouping_var]],    #{{x_grouping_var}},    # input_error_group_by_max_FN_FP, 
                 y    = .data[[y_output_var]],    #{{y_output_var}},    # rsr_COR_euc_out_err_frac, 
                 fill = .data[[x_grouping_var]]    #{{x_grouping_var}}    # input_error_group_by_max_FN_FP
...
#----------
        ...
        #      object 'input_error_group_by_max_FN_FP' not found
