...
#-----  golden-master capture variables (fitting/eval refactor bootstrap; see planning/bdpg_fitting_refactor_plan.md) -----#
  capture_golden_master: TRUE    #  If TRUE, writes frozen input snapshots + all_fitting_scores_df under tests/fixtures/ for the new tidymodels pipeline's golden-master equivalence tests.  Inert (no behavior change) when FALSE.  See DECISIONS.md.
