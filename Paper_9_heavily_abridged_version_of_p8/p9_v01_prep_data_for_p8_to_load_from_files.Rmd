...
library (dataprov)    #  For write-side provenance tracking of prep outputs.
library (DBI)
...
#  Initialize dataprov provenance tracking for this prep run.
...
data_out_loc = file.path (proj_dir, params$relative_path_to_data_out_loc)

sess = prov_session_start (
    reg,
    description = paste0 ("bdpg p9 prep run; gurobi_problem_filter=",
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (sess, full_initial_exp_tib,
                                 "full_initial_exp_tib",
                                 data_out_loc, params, params$file_type_to_write)
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (sess, filtered_full_initial_exp_tib,
                                 "filtered_full_initial_exp_tib",
                                 data_out_loc, params, params$file_type_to_write)
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (sess, cor_tib,
                                 "cor_tib",
                                 data_out_loc, params, params$file_type_to_write)
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (sess, full_app_wrap_tib,
                                 "full_app_wrap_tib",
                                 data_out_loc, params, params$file_type_to_write)
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (sess, filtered_full_app_wrap_tib,
                                 "filtered_full_app_wrap_tib",
                                 data_out_loc, params, params$file_type_to_write)
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (sess, p2_app_wrap_tib,
                                 "p2_app_wrap_tib",
                                 data_out_loc, params, params$file_type_to_write)
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (sess, p3_app_wrap_tib,
                                 "p3_app_wrap_tib",
                                 data_out_loc, params, params$file_type_to_write)
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (
        sess, p3_working_train_df__before_any_preprocessing,
        "p3_working_train_df__before_any_preprocessing",
        data_out_loc, params, params$file_type_to_write)

if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    write_a_tib_with_provenance (
        sess, p3_working_test_df__before_any_preprocessing,
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    {
    write_a_tib_with_provenance (sess, p3_working_train_df,
                                 "p3_working_train_df",
                                 data_out_loc, params, params$file_type_to_write)

    write_a_tib_with_provenance (sess, p3_working_test_df,
                                 "p3_working_test_df",
                                 data_out_loc, params, params$file_type_to_write)
    }
...
if (params$write_tibs_to_csv  |  params$write_most_important_tibs_to_csv)
    {
    write_a_tib_with_provenance (sess, p3_train_aux_df,
                                 "p3_train_aux_df",
                                 data_out_loc, params, params$file_type_to_write)

    write_a_tib_with_provenance (sess, p3_test_aux_df,
                                 "p3_test_aux_df",
                                 data_out_loc, params, params$file_type_to_write)
    }
```

```{r closeProvenanceTracking, include=TRUE}

#  Close out the dataprov session for this prep run and print the session
#  UUID so it can be pinned as params$prep_session_uuid in the main body Rmd.

prov_session_close (sess)

cat ("\n\n=========================================================\n")
message ("PREP SESSION UUID: ", sess$uuid)
cat ("PREP SESSION UUID: ", sess$uuid, "\n", sep='')
cat ("=========================================================\n\n")
...
# Move rest of file to its own file?

The rest of this file is doing exploratory data analysis, particularly analysis of the correlation among features.  It should probably be moved into a separate Rmd file.  However, it assumes that p3_working_train_df is already loaded, so 
that loading would have to be added to the Rmd file.  There may be other assumptions as well, but that's the only one that I know of at the moment.

xxx  

# Notes: Protocol for conducting and presenting results of regression-type analyses  
